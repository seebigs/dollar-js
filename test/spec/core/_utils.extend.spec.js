(function () {
    ...
    describe("utils.extend", function () {
        ...
        describe("when given two objects", function () {
            ...
            it("combines properties from both into one object", function () {
                expect($.utils.extend({ bat: 'man' }, { super: 'man' })).toEqual({ bat: 'man', super: 'man' });
            });

            it("modifies the first object directly", function () {
                var obj = { bat: 'man' };
            ...
            it("overwrites the first with the second", function () {
