(function () {
    ...
    describe("utils.each", function () {
        ...
        describe("when given an array with length", function () {
            it("iterates the array", function () {
                var actual = [],
                    expected = [
                        { ndx: 0, val: 1, col: arr },
                        { ndx: 1, val: 2, col: arr },
        ...
        describe("when given an NodeList", function () {
            it("iterates the NodeList", function () {
        ...
        describe("when given an arguments object", function () {
            it("iterates the arguments", function () {
                var each = $.utils.each;
                var actual = [];
                var expected;
        ...
        describe("when given an object", function () {
            it("iterates the object", function () {
                var actual = [],
                    expected = [
        ...
        describe("when given an object with length (jquery)", function () {
            it("iterates the object as it would an array", function () {
                var jq = $('body'),
                    actual = [],
                    expected = [
        ...
        describe("when an iteratee returns false", function () {
            it("drops out of the loop", function () {
                var lastVal;
